 ...
 * @generated
 */
public class AnswerAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected AnswerSwitch<Adapter> modelSwitch = new AnswerSwitch<>() {
		@Override
		...
		@Override
		public Adapter caseUserAnswers(UserAnswers object) {
			return createUserAnswersAdapter();
		}

		@Override
		public Adapter caseFormAnswers(FormAnswers object) {
			return createFormAnswersAdapter();
		}
	 ...
	 * '{@link org.eclipse.sirius.answer.Answer <em>Answer</em>}'. <!--
