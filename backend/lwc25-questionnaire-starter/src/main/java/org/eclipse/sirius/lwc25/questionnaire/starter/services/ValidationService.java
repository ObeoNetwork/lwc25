...
public class ValidationService {
    ...
    public List<Diagnostic> validateAqlExpression(QuestionnaireElement element, String expression, String feature) {
        ...
        if(expression != null && !expression.isEmpty()) {
            var result = aqlValidator.validate(expression, scopedQuestions);
    ...
    public Optional<Diagnostic> validateEnumeration(String value, EnumerationType type, EObject container, String featureName) {
        ...
        if(!result) {
            return Optional.of(newDiagnostic(String.format("'%s' should be a valid value: %s.", value,
